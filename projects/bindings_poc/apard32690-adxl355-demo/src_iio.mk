# src_iio.mk - IIO example sources for APARD32690 + ADXL355 demo
# Use this instead of src.mk when building the IIO example:
#   make SRCS_FILE=src_iio.mk

# Enable IIO daemon
IIOD = y

# Main IIO example
SRCS += $(PROJECT)/src/main_iio.c
